...
const Disclaimer = ({ className = '' }) => {
  return (
    <div className={`p-4 rounded-xl border border-amber-500/20 bg-amber-500/5 text-amber-800 text-sm flex gap-3 items-start ${className}`}>
      <ShieldAlert className="w-5 h-5 text-amber-600 shrink-0 mt-0.5" />
      <div>
        <h4 className="font-semibold text-amber-900 mb-0.5 font-heading">Disclaimer & Safety Warning</h4>
